    ...
    def validate(self):
        ...
        if self.environment == "production":
            if self.agent_api_key == "dev-key-change-me":
                logger.warning("AGENT_API_KEY is using default value in production — please set it!")
            if self.jwt_secret == "dev-jwt-secret":
                logger.warning("JWT_SECRET is using default value in production — please set it!")
